...
data, fs = sf.read(parent.joinpath("sample.wav"))
...
# 課題4: フィルタリングされた音声を再生
sf.write(parent.joinpath("filtered.wav"), filtered, fs)  # フィルタリングされた音声の書き出し
filtered, fs = sf.read(parent.joinpath("filtered.wav"))  # フィルタリングされた音声の読み込み
